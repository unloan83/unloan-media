# Visual Brief: Risk Management

Visual System: Trading Basics
Mood: Cautious, practical, risk-aware
Color Use: Use deep navy base with amber risk highlights.
Primary Icon Language: Chart line, shield, checklist, risk meter

## Scene-By-Scene Instructions

| Scene | Duration | Visual Direction | On-Screen Text | Production Notes |
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Risk Management Explained Simply | Use assets/logo.png; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Comment RISK if you want a simple trading checklist. | Add educational disclaimer in small readable text. |
