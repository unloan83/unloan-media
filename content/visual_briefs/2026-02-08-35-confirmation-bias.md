# Visual Brief: Confirmation Bias
...
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Confirmation Bias Explained Simply | Use assets/logo.svg; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Save this as an investing behavior checklist. | Add educational disclaimer in small readable text. |
