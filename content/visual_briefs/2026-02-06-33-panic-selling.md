# Visual Brief: Panic Selling

Visual System: Behavioral Finance
Mood: Reflective, human, emotionally intelligent
Color Use: Use navy base with violet insight highlights.
Primary Icon Language: Brain, pause button, mirror, decision fork

## Scene-By-Scene Instructions

| Scene | Duration | Visual Direction | On-Screen Text | Production Notes |
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Panic Selling Explained Simply | Use assets/logo.png; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Comment CALM if you want more investor psychology lessons. | Add educational disclaimer in small readable text. |
