# Visual Brief: Stock Split

Visual System: Market Vocabulary
Mood: Clear, dictionary-like, beginner friendly
Color Use: Use white space, navy text, and gold term highlights.
Primary Icon Language: Book, label, magnifier, definition card

## Scene-By-Scene Instructions

| Scene | Duration | Visual Direction | On-Screen Text | Production Notes |
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Stock Split Explained Simply | Use assets/logo.svg; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Share this with someone confused by stock splits. | Add educational disclaimer in small readable text. |
