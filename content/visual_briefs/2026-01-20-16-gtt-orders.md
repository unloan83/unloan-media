...
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | GTT Orders Explained Simply | Use assets/logo.svg; keep text large and readable on mobile. |
