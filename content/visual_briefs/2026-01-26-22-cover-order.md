...
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Cover Order Explained Simply | Use assets/logo.svg; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Follow UNLOAN for more beginner platform guides. | Add educational disclaimer in small readable text. |
