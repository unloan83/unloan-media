...
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Rule of 72 Explained Simply | Use assets/logo.svg; keep text large and readable on mobile. |
