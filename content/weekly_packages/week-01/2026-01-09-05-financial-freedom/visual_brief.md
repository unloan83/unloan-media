# Visual Brief: Financial Freedom

Visual System: Wealth Building
Mood: Calm, aspirational, disciplined
Color Use: Use deep navy base with emerald highlights.
Primary Icon Language: Growth curve, calendar, savings jar, target

## Scene-By-Scene Instructions

| Scene | Duration | Visual Direction | On-Screen Text | Production Notes |
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Financial Freedom Explained Simply | Use assets/logo.png; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Comment FREEDOM if you want more beginner money lessons. | Add educational disclaimer in small readable text. |
