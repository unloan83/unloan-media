...
Hook: ROE sounds complex, but beginners can understand it in one minute.

Scene Plan:
1. Open with on-screen text: "ROE: Learn It Simply".
2. Define the concept: ROE means understanding the concept clearly before using it in real money decisions.
...
5. Close with: "Learn rOE first, then make calm and informed decisions."
