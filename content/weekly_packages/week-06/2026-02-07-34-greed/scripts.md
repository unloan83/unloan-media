...
Scene Plan:
1. Open with on-screen text: "Greed: Learn It Simply".
2. Define the concept: Greed means understanding the concept clearly before using it in real money decisions.
...
5. Close with: "Learn greed first, then make calm and informed decisions."
