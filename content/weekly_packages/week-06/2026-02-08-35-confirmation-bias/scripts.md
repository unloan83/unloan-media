...
Scene Plan:
1. Open with on-screen text: "Confirmation Bias: Learn It Simply".
2. Define the concept: Confirmation Bias means understanding the concept clearly before using it in real money decisions.
...
5. Close with: "Learn confirmation Bias first, then make calm and informed decisions."
...
Script:
- Confirmation Bias is not something to memorize. It is something to understand.
...
Closing CTA: Save this as an investing behavior checklist.
Disclaimer: Educational content only. This is not financial advice.
