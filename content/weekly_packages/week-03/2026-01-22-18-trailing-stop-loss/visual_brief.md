# Visual Brief: Trailing Stop Loss

Visual System: Investor Toolkit
Mood: Utility-led, precise, platform education
Color Use: Use charcoal panels with cyan functional highlights.
Primary Icon Language: Order ticket, slider, toggle, dashboard panel

## Scene-By-Scene Instructions

| Scene | Duration | Visual Direction | On-Screen Text | Production Notes |
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card, the UNLOAN logo, and one simple symbol. | Trailing Stop Loss Explained Simply | Use assets/logo.png; keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Follow UNLOAN for simple platform education. | Add educational disclaimer in small readable text. |
