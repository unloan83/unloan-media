...
| --- | --- | --- | --- | --- |
| 1 | 0-3s | Open with a clean title card and one simple symbol. | PB Ratio Explained Simply | Keep text large and readable on mobile. |
...
| 5 | 35-45s | End with branded CTA frame. | Share this with someone learning valuation terms. | Add educational disclaimer in small readable text. |
