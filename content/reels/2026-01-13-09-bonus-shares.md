...
Hook: If you are new to stocks, bonus Shares is one term you should know.

Scene Plan:
1. Open with on-screen text: "Bonus Shares: Learn It Simply".
2. Define the concept: Bonus Shares means understanding the concept clearly before using it in real money decisions.
...
5. Close with: "Learn bonus Shares first, then make calm and informed decisions."
