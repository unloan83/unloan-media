...
Hook: Rule of 72 is a beginner money concept that can change how you plan.

Scene Plan:
1. Open with on-screen text: "Rule of 72: Learn It Simply".
2. Define the concept: Rule of 72 means understanding the concept clearly before using it in real money decisions.
...
5. Close with: "Learn rule of 72 first, then make calm and informed decisions."
